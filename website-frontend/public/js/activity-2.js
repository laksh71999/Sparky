...
function setAnimalPrompt() {
    animalPromptLabel.innerHTML = "Sparky would like to know about <span style=\"text-decoration: underline;\">" +
        currentAnimal + "</span>. Could you teach it about them?";
    textFileLabel.innerHTML = "Once you're done teaching Sparky about " +
