...
function startStage() {
    ...
    switch (stages[currStage]) {
        ...
        case 'zAskName':
            ...
            var phrases = ["Hello there! I am sparky. I don't think we've met. What's your name?",
                "Hello! I don't remember meeting you before. What's your name? I am sparky.",
                "Hi there! What’s your name? I am sparky."
            ];
        ...
        case 'respondWithName':
            ...
            infoLabel.innerHTML = 'Sparky says, "What\'s your name?"';
        ...
        case 'respondWithPlace':
            ...
            infoLabel.innerHTML = 'Sparky says, "Where are you from?"';
            ...
            break;
        case 'zFinish':
            infoLabel.innerHTML = 'Find out what Sparky knows about your planet!';
        ...
        case 'respondWithPlace':
            ...
            if (filedata.trim() && !filedata.includes('ERR_NO_TEXT')) {
                ...
                phrases = ["Ooo, " + currPlace + " sounds interesting! I'm from planet Krypton, so I've never heard of " + currPlace + " before! Tell me more!",
                    currPlace + " sounds cool! I have no idea where that is, since I'm from Krypton! I'd love to hear more!",
